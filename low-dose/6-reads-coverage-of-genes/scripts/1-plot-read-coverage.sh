...
script_dire=${working_dire}/low-dose/6-reads-coverage-of-genes/scripts
read_anno_data=${working_dire}/low-dose/3-reads-annotation-and-counting/2-reads-assigned
result_dire=${working_dire}/low-dose/6-reads-coverage-of-genes/results
